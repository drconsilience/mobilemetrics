...
public class PreferencesListener implements SharedPreferences.OnSharedPreferenceChangeListener {
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
    TagSensor sensor = getSensorFromPrefKey(key);
  ...
  private List<TagSensor> enabledSensors() {
    List<TagSensor> sensors = new ArrayList<TagSensor>();
    for (TagSensor sensor : TagSensor.values())
  ...
  private boolean isEnabledByPrefs(final TagSensor sensor) {
